  ...
  render() {
    ...
    return (
      <Container>
        ...
        <ImageBackground style={styles.image_background} source={GlobalInclude.Image6}>
        ...
        {/* BEGIN TO MAKE PROFILE CONTAINER VIEW */}
        <View style={styles.user_profile_sec}>
          <Image style={styles.profile} source={GlobalInclude.Image8} />
        </View>
        {/* END TO MAKE PROFILE CONTAINER VIEW */}
          ...
          <Form style={styles.form}>
            ...
            <Item>
              <Input
                ...
                style={styles.input1}
              />
              {/* BEGIN TO MAKE FORGOT PASSWORD CONTAINER VIEW */}
              <TouchableOpacity style={styles.forgot_label_bg} onPress={() => alert("Forgot Password button clicked.")} >
                <Label style={styles.forgot_label}>Forgot password?</Label>
              </TouchableOpacity>
              {/* END TO MAKE FORGOT PASSWORD CONTAINER VIEW */}
            </Item>
        ...
        <Footer>
          ...
          <TouchableOpacity style={styles.btn_sec} onPress={() => alert("Log In button clicked.")} >
