...
export default class DrawerSmallIcon extends Component {
  constructor(props, context) {
    ...
    this.state = {
      drawerType: "static",
      openDrawerOffset: Dimensions.get("window").width * 0.7,
          ...
          {/* BEGIN TO SETUP HEADER VIEW */}
            ...
            {/* BEGIN TO SETUP LEFT VIEW */}
              <Left style={styles.left}>
                <TouchableOpacity onPress={() => this.openDrawer()} style={[styles.back_arrow, { flexDirection: "row" }]}>
                  <MaterialCommunityIcons name="menu" size={30} color="#fff" />
                  <View style={styles.alert_red} />
                </TouchableOpacity>
              </Left>
            ...
            {/* BEGIN TO SETUP BODY VIEW */}
              <Body style={styles.body}>
                <Text style={styles.text_title}>Drawer Small Icon</Text>
              </Body>
