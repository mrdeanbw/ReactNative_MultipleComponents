...
import {Container,Content,Button,Icon,Right,Item,InputHeader,Header,Left,Body,Title} from "native-base";
          ...
          {/* BEGIN TO SETUP HEADER VIEW */}
            ...
            {/* BEGIN TO SETUP BODY VIEW */}
              <Body style={styles.body}>
                <Text style={styles.text_title}>Drawer Bottom Icon</Text>
              </Body>
