...
import {StyleSheet,Text,SafeAreaView,Dimensions,I18nManager,TouchableOpacity,Platform,View,StatusBar} from 'react-native';
...
export default class CustomExample extends Component {
  ...
  constructor(){
    ...
    //BEGIN TIMELINE DATA
        this.data = [
          {time: '06:00', title: 'Event 1', description: 'TLorem ipsum dolor sit amet, consectetur adipiscing elit. Donec at volutpat metus. Aliquam at sem tincidunt odio laoreet scelerisque id ut orci. ', circleColor: '#009688',lineColor:'#009688'},
          {time: '07:15', title: 'Event 2', description: 'Mauris sed faucibus sem, in porta elit. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas'},
          {time: '08:10', title: 'Event 3'},
          {time: '09:30', title: 'Event 4', description: 'Vivamus mattis egestas eros, in malesuada nibh bibendum eu. ',lineColor:'#009688'},
          {time: '10:30', title: 'Event 5', description: 'Aenean fringilla est at nibh suscipit, id gravida urna placerat. Donec sodales neque id ullamcorper gravida', circleColor: '#009688'}
        ]
    //END TIMELINE DATA
  }
